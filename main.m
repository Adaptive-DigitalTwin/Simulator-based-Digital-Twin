...
calib_data_no_error = data_from_tables2(fullfile(calib_dir, calib_data_file_err_inc), IDs_mat_arr, 2);
...
data_index = 1;
difference_in_bar_chart(ax,solution_data{data_index}(1:2:end,:), calib_data_inc_error{data_index}(1:2:end,:),{'simulation data from calibrated model','calibration data', 'difference'});
