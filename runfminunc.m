...
function [xsol,fval,xval] = runfminunc(x0, source_parameters, parameters, calib_data, simulation_seed_folder, collection_dir, metric_type, data_involved, data_ids, Ids_types, weightage_constant)
...
if isequal(metric_type, 'nmsq')
    fun = @(x) Objective(x, source_parameters, parameters,calib_data, simulation_seed_folder, collection_dir,metric_type, data_involved, data_ids, Ids_types, weightage_constant );
