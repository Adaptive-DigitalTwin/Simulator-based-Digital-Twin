...
par_val = [1.8464    3.0643];
%par_val = [1.8487    3.0890];
 %1.8563    3.0850
...
model_output = py.BEASY_IN_OUT.get_output_data_for_given_parameters(py.list(Parameters), py.list(par_vals), seeding_folder, simulation_result_dir); 
...
scatter3(meas_data(:,[2]),meas_data(:,[3]),meas_data(:,[4]),40,difference_data,'filled')    % draw the scatter plot
