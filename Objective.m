function fobj = Objective(x, parameters,validating_data, simulation_seed_folder, collection_dir, metric_type, response_data_type, IDs, IDs_types, weightage_constant)
